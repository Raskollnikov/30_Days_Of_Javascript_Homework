...
/*
JavaScript is a loosely-typed language. Some times you will get a runtime error when you try to access an undefined
variable or call undefined function etc.
...
try {
    ...
    In any case I will be executed
        ...
        exception, expression specifies the value of the exception. 
...
throwErrorExampleFun()
    ...
    it will help you to debug your code fast.
*/
